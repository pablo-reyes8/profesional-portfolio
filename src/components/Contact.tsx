...
const DEFAULT_EMAILJS_SERVICE_ID = "service_vou5k6v";
const DEFAULT_EMAILJS_TEMPLATE_ID = "template_vzeliwa";
const DEFAULT_EMAILJS_PUBLIC_KEY = "znI3GCso3zti0XcMv";

const SERVICE_ID =
  (import.meta.env.VITE_EMAILJS_SERVICE_ID as string | undefined) || DEFAULT_EMAILJS_SERVICE_ID;
const TEMPLATE_ID =
  (import.meta.env.VITE_EMAILJS_TEMPLATE_ID as string | undefined) || DEFAULT_EMAILJS_TEMPLATE_ID;
const PUBLIC_KEY =
  (import.meta.env.VITE_EMAILJS_PUBLIC_KEY as string | undefined) || DEFAULT_EMAILJS_PUBLIC_KEY;
